...
func (m *MockGrpcClient) GetValue(arg0 context.Context, arg1 string) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockGrpcClient) SetValue(arg0 context.Context, arg1 string, arg2 interface{}) error {
	m.ctrl.T.Helper()
